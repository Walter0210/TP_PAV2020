...
namespace TP_PAV_3k2.Helper
{
    class acceso_BD
    {
        ...
        string cadena_conexion = "Provider=SQLNCLI11;workstation id=PAV-2020-grp7.mssql.somee.com;packet size=4096;user id=Walter0210_SQLLogin_1;pwd=z484w825pu;data source=PAV-2020-grp7.mssql.somee.com;persist security info=False;initial catalog=PAV-2020-grp7";
